-- Mirrored from migrations/024_organizer_website_url.sql
-- Date: 2026-02-16 (Europe/Zurich)
--
-- Detail page data contract. NOT a feed view.
-- Frontend queries by occurrence_id to render the detail page.
-- Feed reads ONLY public.feed_cards_view (unchanged).
